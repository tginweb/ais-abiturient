...
import {EduFisMessageModel as Model} from "./model";
import {EduFisMessageQuery as ModelQuery} from "./query";
import {EntityService} from "~modules/entity/entity.service";
import {EduFisService} from "~modules/edu-org/modules/fis/core/service";
...
@Injectable()
export class EduFisMessageService {
    ...
    constructor(
        ...
        this.entityService.registerEntityType('fis_message', {
            label: '',
    ...
    async importQueue() {
        ...
        const res: any = await this.fisApi.tokenDespatchGet()
