...
import {EduAisMessageModel, EduAisMessageModel as Model} from "./model"
import {EduAisMessageQuery as ModelQuery} from "./query";
import {EduAisMessageService as ModelService} from "./service";
...
@Resolver('EduAisMessage')
export class EduAisMessageResolvers {
    constructor(
    ...
    @Query('edu_ais_message_listRecordset')
    ...
    @Mutation('edu_ais_message_runProcess')
    ...
    async save(@Args() args, @Info() info) {
        ...
        const model: EduAisMessageModel = await this.model.findOne({_id: inputModel._id})
    ...
    @Mutation('edu_ais_message_createFromArgs')
    ...
    @Mutation('edu_ais_message_createFromEntity')
    ...
    @Mutation('edu_ais_message_createFromEntities')
