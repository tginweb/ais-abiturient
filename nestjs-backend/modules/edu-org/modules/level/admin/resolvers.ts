...
import {EduLevelAdminService as ModelAdminService} from "./service"
...
@Resolver('EduLevelAdmin')
export class EduLevelAdminResolvers {
    constructor(
    ...
    @Mutation('edu_level_admin_syncWithAis')
