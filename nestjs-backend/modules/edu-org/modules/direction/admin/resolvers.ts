...
import {EduDirectionAdminService as ModelAdminService} from "./service"
import {EduDirectionModel as Model} from "../core/model"
...
@Resolver('EduDirectionAdmin')
export class EduDirectionAdminResolvers {
    constructor(
    ...
    @Mutation('edu_direction_admin_syncWithAis')
