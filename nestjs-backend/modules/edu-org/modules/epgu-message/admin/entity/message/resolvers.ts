...
import {EduEpguMessageModel, EduEpguMessageModel as Model} from "./model"
import {EduEpguMessageQuery as ModelQuery} from "./query";
import {EduEpguMessageService as ModelService} from "./service";
...
@Resolver('EduEpguMessage')
export class EduEpguMessageResolvers {
    constructor(
    ...
    @Query('edu_epgu_message_listRecordset')
    ...
    @Mutation('edu_epgu_message_importQueue')
    async importQueue(@Args() args, @Info() info) {

        let res = new Response();

        await this.service.importQueue()

        res.addSuccess('Imported', {notify: true})

        return res.getJson()
    }

    @Mutation('edu_epgu_message_runProcess')
    ...
    @Mutation('edu_epgu_message_save')
    async save(@Args() args, @Info() info) {
        ...
        const model: EduEpguMessageModel = await this.model.findOne({_id: inputModel._id})
    ...
    @Mutation('edu_epgu_message_createFromArgs')
    ...
    @Mutation('edu_epgu_message_createFromEntity')
    ...
    @Mutation('edu_epgu_message_createFromEntities')
