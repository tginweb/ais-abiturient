...
export var createPersistedQueryLink = function (options) {
    ...
    var _a = Object.assign({}, defaultOptions, options), generateHash = _a.generateHash, disable = _a.disable,
    ...
    return new ApolloLink(function (operation, forward) {
        ...
        return new Observable(function (observer) {
            ...
            var retry = function (_a, cb) {
                ...
                if (networkError && networkError.result && networkError.result && networkError.result.errors) {
                    if (networkError.result.errors.some(function (msg) {
                        return msg.message === 'PersistedQueryNotFound';
                    }))
