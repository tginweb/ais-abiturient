<template>
  <div class="com">
    ...
    <div class="i-content row  q-col-gutter-x-sm q-col-gutter-lg-x-md">
      ...
      <div class="col-11 col-md-11 col-xl-13">
        ...
        <div class="c-catalog flex q-mt-sm">
      ...
      <div class="col-8 col-md-8 col-xl-7">
        ...
        <div class="c-sale flex no-wrap items-center s-font-xl q-gutter-x-sm q-gutter-lg-x-md q-mt-sm justify-end leading-none">
