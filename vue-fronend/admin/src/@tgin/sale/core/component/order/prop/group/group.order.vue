<template>
  ...
  <div class="com-props-group row q-col-gutter-md-md q-pa-md q-pa-md-none bg-white ">

    <div class="col-24 col-md-5" v-if="$q.screen.gt.md || group.NAME">
      <div class="c-name q-mt-md-sm q-mb-md q-mb-md-none">{{ group.NAME }}</div>
    </div>

    <div class="col-24 col-md-19" :style="colFieldsStyle">

      <div v-if="modeView" style="float:right;">
        <a
          class="text-primary"
          href="#"
        ...
        >
          <template v-if="propIf(prop)">
            ...
            <component
              v-else
              :key="prop.ID"
              v-bind="bindPropInput(prop, modeView)"
              :prop="prop"
              :value="prop.VALUE"
              class="q-mb-md"
