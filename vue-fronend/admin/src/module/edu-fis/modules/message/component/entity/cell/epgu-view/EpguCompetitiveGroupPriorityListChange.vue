...
export default {
  ...
  computed: {
    groups() {
      return this.ensureArray(this.$util.base.deepGet(this.row, 'response.payload.FisCompetitiveGroupPriorityListChange.CompetitiveGroupList.CompetitiveGroup')).map((item) => {
