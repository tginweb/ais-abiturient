<template>
  ...
  <div class="q-gutter-y-md" :key="version">
    ...
    >
      <div class="flex">
        <div>
          <b>{{ appGroup.isBudget ? 'БЮДЖЕТ' : 'КОММЕРЧЕСКИЙ' }}</b>
        </div>
      ...
      >
        ...
        <tr>
          ...
          <th class="bg-blue-grey-5 text-white" rowspan="2" v-if="false">
            Зарегистрировано
          </th>
        ...
        >
          ...
          <td>
            {{$util.date.timestampToFormat(app.registerAtComputed, 'DD MMMM HH:mm')}}
          </td>
          <td>
            <div
          ...
          <td v-if="false">
            {{app.lk.registerAt && $util.date.timestampToFormat(app.lk.registerAt, 'DD MMMM')}}
          </td>
          <td>
            <div
          ...
          <td>
            {{app.ais.registerAt && $util.date.timestampToFormat(app.ais.registerAt, 'DD MMMM')}}
          </td>
          <td>
            <div
          ...
          <td>
            {{app.epgu.registerAt && $util.date.timestampToFormat(app.epgu.registerAt, 'DD MMMM')}}
          </td>
          <td>
            {{app.nid}}
          </td>
