...
export default {
  ...
  computed: {
    groups() {
      return this.ensureArray(this.$util.base.deepGet(this.row, 'response.payload.AisCompetitiveGroupPriorityListChange.CompetitiveGroupList.CompetitiveGroup')).map((item) => {
