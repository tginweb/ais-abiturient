...
export default {
  ...
  computed: {
    groups() {
      return this.ensureArray(this.$util.base.deepGet(this.row, 'response.payload.EpguCompetitiveGroupPriorityListChange.CompetitiveGroupList.CompetitiveGroup')).map((item) => {
